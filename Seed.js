sand.define('Seed', [
  ...
  Seed.prototype = {
    profile : function(str) {
      ...
      if (str) console.log(str, now - this.lastTime);
      this.lastTime = now;
    },
    ...
    query : function(query) {
      // if (!this.mediator) {
      //   return this.query.apply({ mediator : this }, arguments);
      // }

      if (this.mediator) {
        if (typeof(this.mediator.respondsTo) === 'function') {
          return this.mediator.respondsTo.apply(this.mediator, arguments);
        }
        else {
      ...
      //MCB 28/03/17 uncommented following block but dunno why it was commented
      //todo * on self query
      // last resort, happens when we want to query ourselves but already have a mediator, //MCB the mediator will prevail
      if (this.isMediator) {
        if (typeof(this.respondsTo) === 'function') {
          return this.respondsTo.apply(this, arguments);
        }
        else {
          return this.respondsTo[query].apply(this, arguments);
        }
      }
    ...
    create : function(C, o, as) {
      if (!o) o = {};
      if (!o.mediator) o.mediator = this.isMediator ? this : this.mediator;
      o.super = this;
