...
(function (global, factory) {
  ...
  var dispatcher = {
    ...
    addEvent: /*scope.external.addEvent || */function(target, eventName) {
      target.addEventListener(eventName, this.boundHandler, false);
    },
    removeEvent: /*scope.external.removeEvent || */function(target, eventName) {
      target.removeEventListener(eventName, this.boundHandler, false);
    },
    ...
    setCapture: function(inPointerId, inTarget) {
      ...
      document.addEventListener('pointerup', this.implicitRelease, false);
      document.addEventListener('pointercancel', this.implicitRelease, false);
      e._target = inTarget;
    ...
    releaseCapture: function(inPointerId) {
      ...
      if (t) {
        ...
        document.removeEventListener('pointerup', this.implicitRelease, false);
        document.removeEventListener('pointercancel', this.implicitRelease, false);
        e._target = t;
        this.asyncDispatchEvent(e);
      }
    },
